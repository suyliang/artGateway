 ...
 *
 * @param file file logs messages will be written to
 * @param layout a function that takes a logevent and returns a string 
 *   (defaults to basicLayout).
 * @param logSize - the maximum size (in bytes) for a logs file,
 *   if not provided then logs won't be rotated.
 * @param numBackups - the number of logs files to keep after logSize
 *   has been reached (default 5)
 * @param compress - flag that controls logs file compression
