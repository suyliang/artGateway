...
//var objConfig = JSON.parse(fs.readFileSync("uint/log4js.json", "utf8"));
//var objConfig = JSON.parse(fs.readFileSync("/var/lib/cloud9/artGateway/uint/log4js.json", "utf8"));
...
myLog4js.writeDebug = function(msg){
    if(msg == null)
        msg = "";
    logDebug.debug(msg);
};

myLog4js.writeInfo = function(msg){
    if(msg == null)
        msg = "";
    logInfo.info(msg);
};
