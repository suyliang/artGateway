...
/**
 * @fileoverview log4js is a library to logs in JavaScript in similar manner
 ...
 *  logging.addAppender(logging.fileAppender("file.logs"), "some-category");
 *  //get a logger
 *  var logs = logging.getLogger("some-category");
 *  logs.setLevel(logging.levels.TRACE); //set the Level
 *
 *  ...
 *
 *  //call the logs
 ...
 * @param  {String} categoryName name of category to logs to.
...
/**
 * Shutdown all logs appenders. This will first disable all writing to appenders
...
function shutdown(cb) {
  ...
  // not being able to be drained because of run-away logs writes.
