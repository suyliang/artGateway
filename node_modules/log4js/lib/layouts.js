 ...
 * e.g. %5.10p - left pad the logs level by 5 characters, up to a max of 10
 ...
 *  - %n newline
 *  - %z pid
 *  - %x{<tokenname>} add dynamic tokens to your logs. Tokens are specified in the tokens parameter
 * You can use %[ and %] to define a colored block.
 *
 * Tokens are specified as simple key:value objects. 
 * The key represents the token name whereas the value can be a string or function
 * which is called to extract the value to put in the logs message. If token is not
