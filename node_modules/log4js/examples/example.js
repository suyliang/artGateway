...
//logs the cheese logger messages to a file, and the console ones as well.
log4js.configure({
    appenders: [
        {
            type: "file",
...
//you can also set this logs level in the config object
//via the levels field.
logger.setLevel('ERROR');

//console logging methods have been replaced with log4js ones.
//so this will get coloured output on console, and appear in cheese.logs
...
//these end up on the console and in cheese.logs
logger.error('Cheese %s is too ripe!', "gouda");
logger.fatal('Cheese was breeding ground for listeria.');

//these don't end up in cheese.logs, but will appear on the console
