            ...
            "fields": [
                {
                    ...
                    "id": 1,
                    "options": {
                        "default": "GW_DIDO_USEDATE_LIST_IND"
                    }
                },
                {
                    "rule": "required",
                ...
                {
                    "rule": "repeated",
                    "type": "DidoUseDataInfo_t",
                    "name": "didoUseDataList",
                    "id": 4
                }
            ]
        },
        {
            "name": "GwDidoUseDataDeleteReq",
            "fields": [
                {
                    "rule": "required",
                    "type": "CmdId_t",
                    ...
                    "id": 1,
                    "options": {
                        "default": "GW_DIDO_USEDATE_DELETE_REQ"
                    }
                },
                {
                    "rule": "required",
            ...
            "fields": [
                {
                    ...
                    "id": 1,
                    "options": {
                        "default": "GW_CHECK_GATEWAY_UPDATA_REQ"
                    }
                },
                {
                    "rule": "required",
            ...
            "fields": [
                {
                    ...
                    "id": 1,
                    "options": {
                        "default": "GW_CHECK_GATEWAY_UPDATA_RSP"
                    }
                },
                {
                    "rule": "required",
    ...
    "enums": [
        ...
        },
        {
            ...
            "values": [
                ...
                {
                    "name": "GW_DIDO_USEDATE_LIST_IND",
                    "id": 25
                },
                {
                    "name": "GW_DIDO_USEDATE_DELETE_REQ",
                    "id": 26
                },
                {
                    "name": "GW_DIDO_USEDATE_DELETE_RSP",
                    "id": 27
                },
                {
                    "name": "GW_CHECK_GATEWAY_UPDATA_REQ",
                    "id": 28
                },
                {
                    "name": "GW_CHECK_GATEWAY_UPDATA_RSP",
                    "id": 29
                }
            ]
        },
